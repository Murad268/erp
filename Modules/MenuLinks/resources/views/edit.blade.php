                        ...
                        <form method="post" action="{{route('menulinks.update', $menuLink->id)}}">
                            ...
                            <div class="grid grid-cols-1 gap-x-5 sm:grid-cols-2">
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="inputText1" name="title" value="{{old('title', $menuLink->title)}}" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200">
                                </div>
                            </div>
                            @error('title')
                            <div class="grid grid-cols-1 gap-x-5 sm:grid-cols-2">
                            ...
                            @error('code')
                            <div class="mb-3">
                                <label for="textArea" class="inline-block mb-2 text-base font-medium">Svg</label>
                                <textarea name="svg" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" id="textArea" rows="3">{{old('code', $menuLink->svg)}}</textarea>
                            </div>
